...
- `sidebar-error-fetch-failed.png` — the sidebar showing `fetch-failed` with the "Retry" CTA (reproduce by simulating a 5xx on the timed-text endpoint, e.g. via DevTools network throttling).
